...
const Navbar = () => {
  return (
    <div className='flex w-full h-16 font-Outfit shadow-sm'>
        <div className='flex w-4/5 mx-auto justify-center'>
            ...
            <div className='flex items-center w-2/12 space-x-1'>
                ...
                <div className='align-middle font-bold text-lg'>
                    <p>
                        ARISU<br/>
                        SAKAYANAGI
                    </p>
            ...
            <div className='flex-1 items-center justify-end align-middle flex'>
                <div className='flex space-x-4 align-middle px-2 font-bold'>
