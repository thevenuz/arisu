      ...
      <div className='w-4/5 mx-auto p-6 overflow-y-auto no-scrollbar'>
        <div className='w-5/6 mx-auto shadow-md'>
          ...
          <div className='items-center justify-center text-center mt-4'>
                ...
                <p className='font-Content font-bold text-lg'><a className='underline py-1' href={state.Source} target='_blank'>Source</a>{state.Info ? ` - ${state.Info}` : ''}</p>
            </div>
          <div className="post text-xl font-medium mt-4 py-6 px-8 font-Content">
